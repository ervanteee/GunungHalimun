...
@section('title', 'Home Page')  <!-- Set the title of the page -->

@section("contents")
<main class="main">
    <!-- Hero Section -->
    <section id="hero" class="hero section dark-background">
        <img src="assets/img/landing-bg.png" alt="" data-aos="fade-in" />

        <div class="container">
            <div class="row justify-content-center text-center" data-aos="fade-up" data-aos-delay="100">
                <div class="col-xl-6 col-lg-8">
                    <h2>Membangun Masa Depan Indonesia dengan Konstruksi Berkualitas<span>.</span></h2>
                    <p>20+ tahun pengalaman</p>
                </div>
            </div>
            ...
            <div class="row gy-4 mt-5 justify-content-center" data-aos="fade-up" data-aos-delay="200">
                <div class="col-xl-2 col-md-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="icon-box">
                        ...
                        <h3><a href="">Pelajari Lebih Lanjut</a></h3>
                    </div>
                </div>
    ...
    <section id="about" class="about section">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4">
                <div class="col-lg-6 order-1 order-lg-2 bg-sky-900 p-3">
                    <img src="assets/img/sejarah-bg-2.png" class="img-fluid" alt="" />
                </div>
                <div class="col-lg-6 order-2 order-lg-1 content">
                    <h3>Sejarah PT Gunung Halimun</h3>
                    <p class="text-justify">
                        Gunung Halimun didirikan pada tahun 2002 dengan tujuan berkontribusi dalam pembangunan bangsa
                        melalui layanan jasa konstruksi yang berkualitas. Perusahaan ini terus berkembang dengan sukses
                        mengelola berbagai proyek besar, termasuk proyek pemerintah daerah dan nasional di berbagai
                        wilayah Indonesia. Selama lebih dari dua dekade, PT Gunung Halimun telah menunjukkan komitmen
                        pada ketepatan waktu, kualitas, dan kepuasan pelanggan dalam setiap proyek yang dilaksanakan.
                        <br><br>
                        Didukung oleh tim profesional dan berpengalaman, perusahaan ini terus berinovasi dalam
                        pengelolaan manajemen perusahaan, proyek, dan sumber daya manusia. Dengan semangat cinta tanah
                        air, PT Gunung Halimun bertekad untuk memainkan peran aktif dalam mendukung pembangunan
    ...
    <section id="about" class="about section">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 bg-sky-900 p-3">
                    <img src="assets/img/sejarah-bg-2.png" class="img-fluid" alt="" />
                </div>
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="card">
                        <img src="assets/img/sejarah-bg-2.png" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="card">
                        <div class="border-service-card">
                            <img src="assets/img/Fasilitas-Umum.png" class="card-img-top" alt="...">
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Fasilitas Umum</h5>
                            <p class="card-text">Puskesmas Pemkab Musi Rawas Puskesmas Poned Biru Biru Puskesmas Tanjung
                                Ucang
                                etc</p>
                        </div>
                    </div>
